...
const lineDescriptions: Record<string, string> = {
  tradicional:
    "SEM TEMPO? DEIXA COM A GENTE! ❤️\n\nEsse combo é para quem busca praticidade de verdade. Você não perde tempo escolhendo e nem precisa se preocupar com o cardápio. Nossa equipe monta as combinações para você, sempre bem variadas e sortidas para não enjoar.\n\nÉ só aquecer 5 min no micro e aproveitar. A gente cuida do resto!\n\nSeu combo vai bem variado, como nas fotos! 😋\n\nMontamos diferentes combinações com arroz, feijão, lentilha, massa, purê, legumes, frangos, carnes, peixe e outros acompanhamentos, variando bem os sabores entre as marmitas.\n\nNão come ou não gosta de algum item?\nÉ só informar nas observações do pedido que nossa equipe cuida disso para você. ❤️",
  vegetariana:
    "MAIS PRATICIDADE PARA UMA ALIMENTAÇÃO VEGETARIANA! 🌱💚\n\nEsse combo é para quem busca uma alimentação sem carnes, variada e prática, sem precisar perder tempo pensando no cardápio ou preparando marmitas todos os dias.\n\nNossa equipe monta as combinações para você, sempre bem variadas e saborosas, para facilitar sua rotina e não deixar a alimentação cair na mesmice.\n\nÉ só aquecer 5 min no micro e aproveitar! A gente cuida do resto.\n\nSeu combo Vegetariano vai bem variado, como nas fotos! 😋\n\nMontamos diferentes combinações com arroz, feijão, lentilha, massa, purê, batata, aipim, legumes, refogados, seletas, yakisoba, lasanha, panqueca e outros acompanhamentos, variando bem os sabores entre as marmitas.\n\nNão come ou não gosta de algum item?\nÉ só informar nas observações do pedido que nossa equipe cuida disso para você. ❤️\n\nMais variedade. Mais praticidade. Mais tempo para você. 🌱",
  fitness:
    "FOQUE NA SUA DIETA. A GENTE CUIDA DAS MARMITAS! 💪\n\nEsse combo é para quem quer manter o foco na dieta sem perder tempo na cozinha. Nada de passar horas preparando marmitas ou começar a dieta e desistir por falta de praticidade.\n\nNossa equipe monta as combinações para você, sempre variadas e equilibradas para facilitar sua rotina.\n\nÉ só aquecer 5 min no micro e seguir firme no seu objetivo!\n\nSeu combo Fitness vai bem variado, como nas fotos! 😋\n\nMontamos diferentes combinações com arroz integral, feijão, lentilha, purês, legumes, refogados, frangos, carnes, peixe e outros acompanhamentos, variando bem os sabores entre as marmitas.\n\nNão come ou não gosta de algum item?\nÉ só informar nas observações do pedido que nossa equipe cuida disso para você. ❤️\n\nMais praticidade. Mais constância. Mais tempo para focar nos seus resultados. 💪",
  "low-carb":
